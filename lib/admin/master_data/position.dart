...
import 'package:protalent_eksad/admin/master_data/position_api.dart';
                        ...
                        return DataTable(
                            ...
                            rows: List.generate(snapshot.data.length, (index) {
                              ...
                              return DataRow(cells: [
                                DataCell(Text(pgm['idPositionTalent'].toString())),
                                DataCell(Text(pgm['nameTalent'].toString())),
                                // DataCell(Text(pgm['noRs'].toString())),
                                DataCell(
                                    Text(pgm['namePosition'].toString())),
